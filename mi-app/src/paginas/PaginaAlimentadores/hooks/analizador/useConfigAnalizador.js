// hooks/analizador/useConfigAnalizador.js
// Hook para manejar la configuración de un registrador de tipo Analizador
...
/**
 * Hook para manejar la configuración de un analizador
 ...
 */
export function useConfigAnalizador({ configuracionInicial, onChange, obtenerPlantilla }) {
      ...
      Object.entries(plantilla.funcionalidades || {}).forEach(([funcId, func]) => {
         if (func.habilitado !== false) {
            funcActivas[funcId] = {
               nombre: func.nombre,
               habilitado: true,
               registros: func.registros || [{ etiqueta: "", valor: 0 }],
            };
         }
      });
